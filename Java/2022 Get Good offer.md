...
<img src="http://image.easyblog.top/1591417307772e5f35355-683e-4fd0-8b90-a2d6f3ceec09.jpg" style="zoom:70%;" />
...
TCP粘包就是指**发送方发送的若干包数据到达接收方时粘成了一包**，从接收缓冲区来看，后一包数据的头紧接着前一包数据的尾，出现粘包的原因是多方面的，可能是来自发送方，也可能是来自接收方。
