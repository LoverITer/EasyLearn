Kafka在0.11版本中除了引入了[Exactly Once语义](https://www.jianshu.com/p/0943bbf482e9)，还引入了事务特性。**Kafka事务特性是指一系列的生产者生产消息和消费者提交偏移量的操作在一个事务中，或者说是一个原子操作，生产消息和提交偏移量同时成功或者失败。**
